...
//    public static long    CLICK_QUIT_FULLSCREEN_TIME = 0;
    ...
    protected boolean isClickFullScreen = false;
...
//                .findViewById(Window.ID_ANDROID_CONTENT);
    ...
    public boolean backToOtherListener() {//这里这个名字这么写并不对,这是在回退的时候gotoother,如果直接gotoother就不叫这个名字
        ...
        if (currentScreen == JCVideoPlayer.SCREEN_WINDOW_FULLSCREEN
                || currentScreen == JCVideoPlayer.SCREEN_WINDOW_TINY) {
//            if (currentScreen == JCVideoPlayer.SCREEN_WINDOW_FULLSCREEN) {
//                final Animation ra = AnimationUtils.loadAnimation(getContext(), R.anim.quit_fullscreen);
//                startAnimation(ra);
//            }
            onEvent(currentScreen == JCVideoPlayer.SCREEN_WINDOW_FULLSCREEN ?
...
//                .findViewById(Window.ID_ANDROID_CONTENT);
        ...
        try {
            ...
            jcVideoPlayer.setUp(url, JCVideoPlayer.SCREEN_WINDOW_FULLSCREEN, objects);
