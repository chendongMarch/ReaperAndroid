...
public class DetailCollectionDao extends AbstractDao<DetailCollection, String> {
    ...
    */
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, DetailCollection entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DetailCollection entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final String updateKeyAfterInsert(DetailCollection entity, long rowId) {
