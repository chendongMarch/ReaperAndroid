 ...
 *
 */
public class SwipeFinishLayout extends RelativeLayout implements
        OnTouchListener {
    /**
    ...
    /**
     * 设置onSwipeFinishListener, 在onSwipeFinish()方法中finish Activity
     *
     * @param onSwipeFinishListener
     */
    public void setOnSwipeFinishListener(
            OnSwipeFinishListener onSwipeFinishListener) {
    ...
    public void computeScroll() {
        ...
        if (mScroller.computeScrollOffset()) {
            ...
            if (mScroller.isFinished()) {
                ...
                if (onSwipeFinishListener != null && isFinish) {
                    onSwipeFinishListener.onSwipeFinish();
                }
            }
        }
    }
