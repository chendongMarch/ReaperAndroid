...
//            Bitmap thumbImage = VideoThumbImageHelper.get().getThumbImage(url);
//            thumbImageView.setImageBitmap(thumbImage);
    ...
    protected void onDetachedFromWindow() {
        ...
        if (isCurrentMediaListener() && Constant.IsVideoScrolled) {
            Logger.e("onDetachedFromWindow and isCurrentMediaListener");
...
//                    }
    ...
    public void showWifiDialog() {
        ...
        new AlertDialog.Builder(getContext())
                .setTitle("Wifi未连接")
                .setMessage("Wifi网络未连接，继续播放将消耗流量")
