...
public class AlbumDetailDao extends AbstractDao<AlbumDetail, Void> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, AlbumDetail entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(AlbumDetail entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(AlbumDetail entity, long rowId) {
