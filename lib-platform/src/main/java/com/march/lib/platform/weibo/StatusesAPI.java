...
public class StatusesAPI extends AbsOpenAPI {
     ...
     * @param listener
     */
    public void upload(String content, ByteArrayOutputStream byteArrayOutputStream, String lat, String lon, RequestListener listener) {
        WeiboParameters params = buildUpdateParams(content,lat,lon);
    ...
    public void upload(String status, ByteArrayOutputStream byteArrayOutputStream, RequestListener listener) {
